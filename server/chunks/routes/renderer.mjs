...
const appHead = {"meta":[{"name":"viewport","content":"width=device-width, user-scalable=no, initial-scale=1.0, maximum-scale=1.0, minimum-scale=1.0,  viewport-fit=cover"},{"charset":"utf-8"}],"link":[{"rel":"stylesheet","href":"/css/style.css"}],"style":[],"script":[],"noscript":[],"charset":"utf-8","viewport":"width=device-width, user-scalable=no, initial-scale=1.0, maximum-scale=1.0, minimum-scale=1.0,  viewport-fit=cover","htmlAttrs":{"lang":"ko"}};
