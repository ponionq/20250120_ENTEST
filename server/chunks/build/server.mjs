...
const _routes = [
  {
    name: "about",
    path: "/about",
    component: () => import('./about-B6O_rvLv.mjs')
  },
  {
    name: "contact",
    path: "/contact",
    component: () => import('./contact-DElsYLOd.mjs')
  },
  {
    name: "index",
    path: "/",
    component: () => import('./index-C60899VT.mjs')
  }
];
...
const layouts = {
  default: defineAsyncComponent(() => import('./default-D5QG7q31.mjs').then((m) => m.default || m))
};
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const _Error404 = defineAsyncComponent(() => import('./error-404-D2F3ROBs.mjs'));
    const _Error = defineAsyncComponent(() => import('./error-500-zSPB0zs3.mjs'));
